...
Data.eta_D_real     =       0.15     ;
Data.eta_A_real     =       0.2     ;

% Absorbsion cross-talk of the acceptor rate times pulse width
Data.ex_A_real      =      10^-6*[1  2]      ;

% Absorbsion cross-talk of the donor rate times pulse width
Data.ex_D_real      =      10^-3*[ 2  4]   ; 

% FRET rates of each state
Data.KF_val_real    = [  0.1  4 ];

% Donor lifetime of each PIFE state 
Data.KD_val_real    = [  2    4   ];

% Acceptor lifetime of each PIFE state of acceptor
Data.KA_val_real    = [  2    4   ];
...
Data.Num_states_D          =      2                                       ; % Number of Donor_PIFE states
Data.Num_states_A          =      2                                       ; % Number of Acceptor_PIFE states
...
Data.prop_mu_D_ex          =  10000                                       ;
Data.alpha_mu_D_ex         =      1                                       ;
Data.beta_mu_D_ex          =      0.01                                    ;

Data.prop_mu_A_ex          =  10000                                       ;
Data.alpha_mu_A_ex         =      1                                       ;
Data.beta_mu_A_ex          =      0.01                                    ;


%%%%%%%%%%%%%%%%     Parameters of background rates    %%%%%%%%%%%%%%%%%%%%
Data.prop_mu_BD            =  10000                                       ;
Data.alpha_mu_BD           =      1                                       ;
Data.beta_mu_BD            =      0.01                                    ;

Data.prop_mu_BA            =  10000                                       ;
Data.alpha_mu_BA           =      1                                       ;
Data.beta_mu_BA            =      0.01                                    ;
...
Data.KF_val_prop           =  10000                                       ;
Data.KF_val_alpha          =      1+10e-4                                 ;
Data.KF_val_beta           =     10                                       ;

%%%%%%%%%%%%%%%%      Parameters of donor lifetimes    %%%%%%%%%%%%%%%%%%%%
Data.KD_val_prop           =  10000                                       ;
Data.KD_val_alpha          =      2                                       ;
Data.KD_val_beta           =      2                                       ;

%%%%%%%%%%%%%%%%     Parameters of acceptor lifetimes    %%%%%%%%%%%%%%%%%%
Data.KA_val_prop           =  10000                                       ;
Data.KA_val_alpha          =      2                                       ;
Data.KA_val_beta           =      2                                       ;
