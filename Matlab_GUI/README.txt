...
The sub-functions are described in the following publication:
 
    Fluorescence lifetime analysis of smFRET with the contribution of PIFE on donor and acceptor
    Sina Jazani and Taekjip Ha, biorxiv (2023), DOI: 
...
1) To use this software, please install the app on Matlab, or run the source code directly.
